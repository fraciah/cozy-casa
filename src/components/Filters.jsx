...
export function Filters(){
    ...
    return(
        ...
        <div className="px-5 sm:px-10 flex items-center pt-1 sm:pt-3 flex-wrap pb-2">
            ...
            <div id="slider" className="w-full items-center flex gap-7 sm:gap-7 pt-2 text-gray-500 pb-0 overflow-x-scroll scroll whitespace-nowrap scroll-smooth scrollbar-hide">
                ...
                <div className="flex text-black items-center">
                    ...
                    <div className="flex border py-2 sm:py-3 px-2 sm:px-3 rounded-xl items-center cursor-pointer mx-2 sm:mx-3">
                        <LiaFilterSolid className="mr-1"/>
                        <h1 className="text-xs font-semibold">Filters</h1>
                    </div>

                    <div className="flex border py-2 sm:py-3 px-2 sm:px-3 rounded-xl items-center cursor-pointer">
