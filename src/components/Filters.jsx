...
export function Filters(){
    ...
    return(
        ...
        <div className="px-5 sm:px-10 flex items-center pt-1 sm:pt-3 flex-wrap pb-1">
            ...
            <div className="flex gap-3 sm:gap-4 py-1 mr-1 text-gray-500 pb-0">
                <div className="flex flex-col items-center w-16 sm:w-20 pb-3 border-b-0 sm:border-b-2 border-gray-800 text-gray-800">
                    <HiOutlineHomeModern className="text-xl sm:text-3xl"/>
                    <h1 className="text-xs">Tiny homes</h1>
                </div>
                <div className="flex flex-col items-center w-16 sm:w-20 pb-3 hover:text-gray-800 hover:border-b-0 sm:hover:border-b-2 cursor-pointer">
                    <BsFire className="text-xl sm:text-3xl"/>
                    <h1 className="text-xs">Trending</h1>
                </div>
                <div className="flex flex-col items-center w-16 sm:w-20 pb-3 hover:text-gray-800 hover:border-b-0 sm:hover:border-b-2 cursor-pointer">
                    <MdDesk className="text-xl sm:text-3xl"/>
                    <h1 className="text-xs">Rooms</h1>
                </div>
                <div className="flex flex-col items-center w-16 sm:w-20 pb-3 hover:text-gray-800 hover:border-b-0 sm:hover:border-b-2 cursor-pointer">
                    <TbHomeStar className="text-xl sm:text-3xl"/>
                    <h1 className="text-xs">Design</h1>
                </div>
                <div className="flex flex-col items-center w-16 sm:w-20 pb-3 hover:text-gray-800 hover:border-b-0 sm:hover:border-b-2 cursor-pointer">
                    <TbBeach className="text-xl sm:text-3xl"/>
                    <h1 className="text-xs">Beachfront</h1>
                </div>
                <div className="flex flex-col items-center w-16 sm:w-20 pb-3 hover:text-gray-800 hover:border-b-0 sm:hover:border-b-2 cursor-pointer">
                    <BiLandscape className="text-xl sm:text-3xl"/>
                    <h1 className="text-xs">Amazing views</h1>
                </div>
                <div className="flex flex-col items-center w-16 sm:w-20 pb-3 hover:text-gray-800 hover:border-b-0 sm:hover:border-b-2 cursor-pointer">
                    <LuSailboat className="text-xl sm:text-3xl"/>
                    <h1 className="text-xs text-center">Boats</h1>
                </div>
                <div className="flex flex-col items-center w-16 sm:w-20 pb-3 hover:text-gray-800 hover:border-b-0 sm:hover:border-b-2 cursor-pointer">
                    <LiaSwimmingPoolSolid className="text-xl sm:text-3xl"/>
                    <h1 className="text-xs">Amazing pools</h1>
                </div>
                <div className="flex flex-col items-center w-16 sm:w-20 pb-3 hover:text-gray-800 hover:border-b-0 sm:hover:border-b-2 cursor-pointer">
                    <LiaGolfBallSolid className="text-xl sm:text-3xl"/>
                ...
                <div className="flex flex-col items-center justify-center rounded-full cursor-pointer p-2 w-7 sm:w-9 h-7 sm:h-9 border hover:shadow-md transform transition duration-500 ease-in-out hover:scale-110">
                    <MdKeyboardArrowRight className="text-4xl sm:text-2xl text-black"/>
                </div>
            </div>
            ...
            <div className="flex border py-1 sm:py-3 px-2 sm:px-4 rounded-xl items-center cursor-pointer mt-0 sm:mt-5 md:mt-0">
